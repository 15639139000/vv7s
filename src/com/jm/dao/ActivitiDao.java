...
public interface ActivitiDao {
	...
	public String selectProcessNameById(@Param("procdefId") String procdefId);
	
	public List<String> selectTaskIdByEname(@Param("eName") String eName);
	
	public List<Map<String, Object>> applicationNumber(@Param("eName") String eName);
	
	public Integer getFollowCount(@Param("taskId") String taksId, @Param("eName") String eName);
