...
public class NoticeBulletinServiceImpl implements NoticeBulletinService{
	...
	@Override
	public PageInfo<NoticeBulletin> getAll(Integer pageNo,Integer num)
	{
	...
	@Transactional(readOnly = true)
	@Override
	public NoticeBulletin getNoticeBulletinById(Integer nbId) {
		return noticeBulltinDao.getNoticeBulletinById(nbId);
	}
}
