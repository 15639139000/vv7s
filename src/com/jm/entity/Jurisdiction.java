...
public class Jurisdiction implements Serializable{
	...
	private String childrenRoles;//拥有子节点的角色集合字符串
	public Integer getjId() {
		return jId;
	}

	public String getChildrenRoles() {
		return childrenRoles;
	}

	public void setChildrenRoles(String childrenRoles) {
	...
	public Jurisdiction(String jName, String jDesc, String jUrl, String jIcon, String jInterceptorRule,
			...
			String roles, String childrenRoles) {
		super();
		this.jName = jName;
		this.jDesc = jDesc;
		this.jUrl = jUrl;
