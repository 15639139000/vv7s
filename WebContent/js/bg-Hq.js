$(function(){
	...
	//父级菜单过滤
	$("#queryByMenu").click(function(){
		searchTaskBy(1, "金迈衡器",'办公管理');
	});
	$("#queryByMenus").click(function(){
		searchTaskBy(1, "金迈衡器",'财务管理');
	});
	...
	$("#intoYl").click(function(){
		...
		$("#page2").empty();
		search(1,"鑫鑫园林");
		window.location.href = path + "/allTask/GetYl";
	})
});
...
$("#search").click(function(){
	...
	searchTaskByCondition(1, startTime1, star, eName, forCla1, message1,"金迈衡器");
});
