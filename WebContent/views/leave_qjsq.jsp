					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<br /><p class="p1">详情信息</p>
									<span>紧急程度：</span>
									<input class="j2222" type="text" name="inLineOptions1" id="inlineRadio3" value="${data.inLineOptions1 }" disabled />
									<div class="hx"></div>
									...
									<div class="jj13-lf">
									    ...
									    <input type="hidden" id="reserve12" value="${data.reserve12 }">
									</div>
									<div class="jj13-rg">
										<span>请假类型：</span>
									    <input type="text" class="j2222" name="inLineOptions2" value="${data.inLineOptions2 }" disabled /> 
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/leave_qjsq.js"></script>
