						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								<div class="input-group1-1">
									<div class="iput">
										<p class="p1">申请人信息</p>
										<span class="t1">姓名：</span><input type="text" name="reserve1" value="${data.reserve1 }" disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">性别：</span><input type="text" name="reserve2" value="${data.reserve2 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">年龄：</span><input type="text" name="reserve3" value="${data.reserve3 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">文化程度：</span><input type="text" name="reserve4" value="${data.reserve4 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">专业：</span><input type="text" name="reserve5" value="${data.reserve5 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">职称：</span><input type="text" name="reserve6" value="${data.reserve6 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
								...
								<div class="jj13">
									<span>紧急程度：</span>
									<input type="text" class="j222" name="inLineOptions1" id="inlineRadio3" value="${data.inLineOptions1 }" disabled /> 
									<div class="hx"></div>
									<span>异动类型：</span>
									<input class="j222" type="text" name="inLineOptions2" value="${data.inLineOptions2 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
								</div>
								<div  class="input-group1-2">
								    <div class="iput">
									<p class="p1">岗位及待遇</p>
										<span class="t1">【原任】&nbsp;&nbsp;部门：</span><input type="text" name="reserve7" value="${data.reserve7 }" disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">职务：</span><input type="text" name="reserve8" value="${data.reserve8 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">薪资：</span><input type="text" name="reserve9" value="${data.reserve9 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">到任日：</span><input type="text" name="reserve10" value="${data.reserve10 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
									<div class="iput">
										<span class="t1">【新任】&nbsp;&nbsp;部门：</span><input type="text" name="reserve11" value="${data.reserve11 }" disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">职务：</span><input type="text" name="reserve12" value="${data.reserve12 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">薪资：</span><input type="text" name="reserve13" value="${data.reserve13 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu2">|</span>
										<span class="t1">到任日：</span><input type="text" name="reserve14" value="${data.reserve14 }"  disabled class="i-3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
								 </div>
								<div class="jj13">
									<span>任职要求：</span>
									<textarea class="ccsq-sqsy" name="reserve15" style="width: 860px; background: #fff; margin-top: 8px;" placeholder="" disabled>${data.reserve15 }</textarea>
									<div class="hx"></div>
								</div>
								<div class="input-group1-2">
									<div class="iput">
...
<script type="text/javascript" src="${path }/js/changeOfPersonal_rsyd.js"></script>
