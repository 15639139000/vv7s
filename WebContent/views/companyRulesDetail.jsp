				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb ccsq-dh">
							<li><a href="#">公司制度内容</a></li>
						</ol>
					</div>
				</div>
				<div class="notice_box">
					<h2 class="text-center">${companyRules.crTitle}</h2><br><br>
					<div class="notice_contion">
						<p style="font-size:16px;line-height:30px">
					${companyRules.crContent}
						</p>
					</div>
				</div>
				<br><br><br><br><br><br>
				<div class="notice_time">
					<p style="font-size:16px;">${companyRules.dept.dName}</p>
					<p style="font-size:16px;">${companyRules.employee.eName}</p>
					<p style="font-size:16px;"><fmt:formatDate value="${companyRules.crDate}" pattern="yyyy-MM-dd"/></p>
				</div>
			</div>
		</div>
	</div>
