...
<%
	...
	pageContext.setAttribute("page", "lendMoney.jsp");
%>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="jj13-lf">
										<span>借款金额：</span>
									    <input type="text" class="j2222" name="reserve5" id="reserve5" value="${data.reserve5 } , ${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>有无未还借款：</span><input class="j2222" type="text" name="inLineOptions2" id="inlineRadio3" value="${data.inLineOptions2 }" disabled />
									</div>
									<div class="jj13-rg">
										<span>借款性质：</span>
									    <input type="text" class="j2222" name="reserve8" id="reserve8" value="${data.reserve8 }" disabled />
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
								<div class="jj13">
									<span>借款事由：</span>
								    <textarea class="ccsq-sqsy" style="width: 860px; background:#fff; margin-top: 8px;" disabled>${data.reserve7 }</textarea>
									<div class="hx"></div>
							    </div>
...
<script type="text/javascript" src="${path }/js/lendMoney_jksq.js"></script>
