...
<%
	...
	pageContext.setAttribute("name", "印刷品印刷申请");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabProduct1">
											<c:choose>
												<c:when test="${data.message == '驳回' }">
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">印刷物品名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">印刷数量</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount2" EditType="TextBox">要求完成时间</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount3" EditType="TextBox">印刷事由</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount4" EditType="TextBox">印刷要求</td>
												</tr>
												</c:when>
												<c:otherwise>
												<tr class="ccsq-bdbt">
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount">印刷物品名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1">印刷数量</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount2">要求完成时间</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount3">印刷事由</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount4">印刷要求</td>
				                                </tr>
												</c:otherwise>
											</c:choose>
										</table>
									...
									<div class="ccsq-jtmx">
										<h3>印章反馈明细</h3>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabProduct2">
													...
													<tr class="ccsq-bdbt">
														<td width="32" align="center" bgcolor="#EFEFEF" Name="Num"><input type="hidden" name="checkbox" value="checkbox" /></td>
														<td width="700" bgcolor="#EFEFEF" Name="Num">序号</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount">印刷单位</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount1">联系人电话</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount2">印刷单价</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount3">印刷总价</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount4">印刷完成时间</td>
													</tr>
								...
								<div class="ccsq-xx">
									<span>备注：</span>
									<textarea class="ccsq-sqsy" placeholder="" name="reserve5" id="reserve5">${data.reserve5 }</textarea>
							    </div> 
...
<script type="text/javascript" src="${path }/js/printing_yspsq_his.js"></script>
