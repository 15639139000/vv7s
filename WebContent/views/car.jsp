...
<%
	...
	pageContext.setAttribute("page", "car_ycsq.jsp");
							...
							<div id="leave3">
								...
								<div class="ccsq-xx"><span>用车时间：</span>
										...
										<span style="font-family: '微软雅黑'; font-size: 14px;">
											...
											请假时长：<span style="color: red;" id="date">0天0时</span>&nbsp;&nbsp;&nbsp;&nbsp;
										</span>
	                            </div>
								<div class="ccsq-xx">
								...
								<div class="ccsq-xx">
									   <span>行程安排：</span><input type="text" id="reserve11" name="reserve11" placeholder="请输入出发地" value="" class="ccsq-jbin" />&nbsp;至 &nbsp;
									   					    <input type="text" id="reserve12" name="reserve12" placeholder="请输入目的地" value="" class="ccsq-jbin" /></br>
									</div>
									<div class="ccsq-xx">
									   <span>随车人数：</span><input type="number" id="reserve13" name="reserve13" class="ccsq-jbin" />&nbsp;人 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
								<div class="ccsq-xx">
									<span>申请事由：</span>
									<textarea class="ccsq-sqsy" name="reserve10" id="reserve10" placeholder="请输入请假原因......"></textarea>
								</div>
...
<script type="text/javascript" src="${path }/js/overtime.js"></script>
