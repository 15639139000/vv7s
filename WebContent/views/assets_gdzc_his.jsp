...
<%
	...
	pageContext.setAttribute("page", "assets.jsp");
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<form method="post" id="form" enctype="multipart/form-data">
								<div class="nryc">
									...
									<div class="ccsq-xx">
										<span>物品名称：</span><input type="text" id="reserve5" name="reserve5" class="ccsq-jbin" value="${data.reserve5 }"/>&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>借出原因：</span><textarea class="ccsq-sqsy" id="reserve6" name="reserve6">${data.reserve6 }</textarea>&nbsp;<br><!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
...
<script type="text/javascript" src="${path }/js/assets_gdzc_his.js"></script>
