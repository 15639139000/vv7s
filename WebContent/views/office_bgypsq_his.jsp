...
<%
	...
	pageContext.setAttribute("page", "office.jsp");
	pageContext.setAttribute("name", "办公用品申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>办公用品申请历史</title>
											...
											<c:choose>
												<c:when test="${data.message == '驳回' }">
													<tr class="ccsq-bdbt">
														...
														<td width="400" bgcolor="#EFEFEF" Name="Num" EditType="TextBox">序号</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">物品名称</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">规格型号</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount2" EditType="TextBox">数量</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount3" EditType="TextBox">估计价格</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount4" EditType="TextBox">用途</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount5" EditType="TextBox">需用日期</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount6" EditType="TextBox">使用人</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount7" EditType="TextBox">备注</td>
													</tr>
												</c:when>
												<c:otherwise>
													<tr class="ccsq-bdbt">
														<td width="32" align="center" bgcolor="#EFEFEF" Name="Num"><input type="hidden" name="checkbox" value="checkbox" /></td>
														<td width="400" bgcolor="#EFEFEF" Name="Num">序号</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount">物品名称</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount1">规格型号</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount2">数量</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount3">估计价格</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount4">用途</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount5">需用日期</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount6">使用人</td>
														<td width="600" bgcolor="#EFEFEF" Name="Amount7">备注</td>
													</tr>
												</c:otherwise>
											</c:choose>
										</table>
...
<script type="text/javascript" src="${path }/js/office_bgypsq_his.js"></script>
