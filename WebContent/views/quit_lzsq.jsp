						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>入职时间：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>
									    <span>离职类型：</span><input type="text" class="j2222" value="${data.inLineOptions2 }" disabled />
									</div>
									<div class="jj13-lf">
										<span>预计离职时间：</span><input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>离职原因：</span><input type="text" class="j2222" value="${data.reserve7 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
								<div class="jj13">
									<span>详细说明：</span>
								    <textarea class="ccsq-sqsy" style="width: 860px; background:#fff; margin-top: 8px;" disabled>${data.reserve8 }</textarea>
									<div class="hx"></div>
							    </div>
...
<script type="text/javascript" src="${path }/js/quit_lzsq.js"></script>
