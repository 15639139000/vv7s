						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>物品名称：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
								<div class="jj13">
									<span>借出原因：</span>
								    <textarea class="ccsq-sqsy" style="width: 860px; background:#fff; margin-top: 8px;" disabled>${data.reserve6 }</textarea>
									<div class="hx"></div>
							    </div>
...
<script type="text/javascript" src="${path }/js/assets_gdzc.js"></script>
