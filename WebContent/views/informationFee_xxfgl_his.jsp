...
<%
	...
	pageContext.setAttribute("page", "informationFee.jsp");
	pageContext.setAttribute("name", "信息费管理");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx" style="margin-top: 30px;">
									<span>紧急程度：</span> 
								...
								<div class="ccsq-jbxx">信息费信息</div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>客户名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve1" id="reserve1" value="${data.reserve1 }"></div>
									   <span>客户编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve2" id="reserve2" value="${data.reserve2 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>客户账号：</span><input class="ccsq-jbpt-1" type="text" name="reserve3" id="reserve3" value="${data.reserve3 }"></div>
									   <span>开户行：&nbsp;&nbsp;&nbsp;&nbsp;</span><input class="ccsq-jbpt-1" type="text" name="reserve4" id="reserve4" value="${data.reserve4 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }"></div>
									   <span>产品编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>结算数量：</span><input class="ccsq-jbpt-1"  type="number" name="reserve7" id="reserve7" value="${data.reserve7 }"></div>
										<span>单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</span>
										<input class="ccsq-jbpt-1"  type="number" name="reserve8" id="reserve8" value="${data.reserve8 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   	<span>结算金额：</span>
									   	<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve9" id="reserve9" value="${data.reserve9 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve10" id="reserve10" value="${data.reserve10 }">
									    <span style="padding:3px 6px;color:red;position:absolute;" id="error1"></span>
									   </div>
										<span>信息费结算依据：</span>
										<input class="ccsq-jbpt-1"  type="text" name="reserve15" id="reserve15" value="${data.reserve15 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 85px; float: left;">
									   	<span>信息费金额：</span>
									   	<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve13" id="reserve13" value="${data.reserve13 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve14" id="reserve14" value="${data.reserve14 }">
									  	<span style="padding:3px 6px;color:red;position:absolute;" id="error3"></span>
									   </div>
										<span>客户性质：</span><input class="ccsq-jbpt-1" type="text" name="inLineOptions2" id="inLineOptions2" value="${data.inLineOptions2 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>回款金额：</span>
										<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve11" id="reserve11" value="${data.reserve11 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve12" id="reserve12" value="${data.reserve12 }">
									   <span style="padding:3px 6px;color:red;position:absolute;" id="error2"></span>
									   </div>
										<span>客户地址：</span>
										<input class="ccsq-jbpt-1"  type="text" name="inLineOptions3" id="inLineOptions3" value="${data.inLineOptions3 }">
								    </div>
								...
								<div class="ccsq-jtmx">
											...
											<c:choose>
												<c:when test="${data.message == '驳回' }">
													<tr class="ccsq-bdbt">
														...
														<td width="700" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">使用人</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">部门</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount2" EditType="TextBox">金额</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount3" EditType="TextBox">联系方式</td>
													</tr>
												</c:when>
												<c:otherwise>
													<tr class="ccsq-bdbt">
														...
														<td width="700" bgcolor="#EFEFEF" Name="Amount">使用人</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount1">部门</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount2">金额</td>
														<td width="700" bgcolor="#EFEFEF" Name="Amount3">联系方式</td>
													</tr>
												</c:otherwise>
											</c:choose>
										</table>
								 ...
								 <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   	<span>合计金额：</span>
									   	<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="inLineOptions4" id="inLineOptions4" value="${data.inLineOptions4 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="tableData2" id="tableData2" value="${data.tableData2 }">
									   <span style="padding:3px 6px;color:red;position:absolute;" id="error4"></span>
									   </div>
										<span>支付方式：</span>
										<input class="ccsq-jbpt-1"  type="text" name="tableData3" id="tableData3" value="${data.tableData3 }">
								    </div>
								    <div class="ccsq-xx">
										<span>详情备注：</span>
										<textarea class="ccsq-sqsy" placeholder=""  name="tableData4" id="tableData4">${data.tableData4 }</textarea>
								    </div>
...
<script type="text/javascript" src="${path }/js/informationFee_xxfgl.his.js"></script>
