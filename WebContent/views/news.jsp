...
<link type="text/css" rel="stylesheet" href="${path }/bootstrap/css/news.css" />
...
<script type="text/javascript" src="${path }/ueditor/umeditor.min.js"></script>
								...
								<div class="col-md-12">
									...
									<div class="tile" id="edit">
										...
										<div style="padding-left: 75px; padding-bottom: 20px; font-size: 14px; width: 100%;">
											...
											新闻标题：<input type="text" value="" id="newsTitle" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px;" /><span class="error1"></span></br>
											<div style="margin-top: 20px;">
												新闻内容：
												<textarea placeholder="请输入发布的新闻内容......." id="newsContent" style="width: 600px; height: 200px; background-color: #f5f5f5; border: none;"></textarea>
												<script type="text/javascript">
