...
<%
	...
	pageContext.setAttribute("page", "recruit.jsp");
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								<div class="input-group1-1">
									<div class="iput">
										<p class="p1">申请人信息</p>
										<span class="t1">姓名：</span><input type="text" value="${data.applicant }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">公司：</span><input type="text" value="${applyCompany }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">部门：</span><input type="text" value="${applyDept }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">职称：</span><input type="text" value="${applyManager }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<span>申请部门：</span><input class="ccsq-jbpt" style="width: 180px;" type="text" name="reserve1" id="reserve1" value="${data.reserve1 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>需求岗位：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="ccsq-jbpt" style="width: 180px;" type="text" name="reserve2" id="reserve2" value="${data.reserve2 }"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>需求人数：</span>&nbsp;&nbsp;&nbsp;<input class="ccsq-jbpt" style="width: 180px;" type="number" name="reserve3" id="reserve3" value="${data.reserve3 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<span>岗位编制：</span><input class="ccsq-jbpt" style="width: 180px;" type="text" name="reserve4" id="reserve4" value="${data.reserve4 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>岗位实有人数：</span><input class="ccsq-jbpt" style="width: 180px;" type="number" name="reserve5" id="reserve5" value="${data.reserve5 }"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>拟到岗日期：</span><input class="ccsq-jbpt" style="width: 180px;" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div class="ccsq-xx">
									<span>申请理由：</span>
									<input type="radio" name="inLineOptions2" id="inlineRadio1" value="新增编制" checked="checked"> 新增编制&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="inLineOptions2" id="inlineRadio2" value="离职补充"> 离职补充&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<div class="input-group1-2">
									<div class="iput">
										    ...
										    <input type="hidden" value="${data.reserve11 }" id="reserve111" />
											<span class="shu">|</span>
										    <span>年龄：</span>   
										    <input type="text" name="reserve7" id="reserve7" value="${data.reserve7 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5;">
										    <span class="shu">|</span>
										    <span>婚姻状况：</span>
										    ...
										    <input type="hidden" value="${data.reserve12 }" id="reserve112" />
									    </div>
									    <div class="iput">
											<span>学历：</span>
										    ...
										    <input type="hidden" value="${data.reserve13 }" id="reserve113" />
											<span class="shu">|</span>
										    <span>专业：</span>   
										    <input type="text" name="reserve8" id="reserve8" value="${data.reserve8 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5;">
										    <span class="shu">|</span>
										    <span>经&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;验：</span>
										    ...
										    <input type="hidden" value="${data.reserve14 }" id="reserve114" />
									<div class="ccsq-xx" style="margin-left:0px; margin-top: 30px;">
												<span>详细说明：</span>
												<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve9" id="reserve9">${data.reserve9 }</textarea>
									        </div>
									        <div class="ccsq-xx" style="margin-left:0px; margin-top: 30px;">
												<span>工作职责：</span>
												<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve10" id="reserve10">${data.reserve10 }</textarea>
									        </div>
								 </div>
								 </div>
...
<script type="text/javascript" src="${path }/js/recruit_zpsq_his.js"></script>
