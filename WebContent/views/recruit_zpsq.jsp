					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<span>紧急程度：</span><input class="j2222" type="text" value="${data.inLineOptions1 }" disabled />
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>申请部门：</span><input type="text" class="j2222" value="${data.reserve1 }" disabled /> 
									    <div class="hx"></div>
									    <span>岗位编制：</span><input type="text" class="j2222" value="${data.reserve4 }" disabled /> 
									    <div class="hx"></div>
									    <span>岗位实有人数：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									</div>
									<div class="jj13-rg">
										<span>需求岗位：</span>
									    <input type="text" class="j2222" value="${data.reserve2 }" disabled /> 
									    <div class="hx"></div>
									    <span>拟到岗日期：</span><input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>	
									    <span>需求人数：</span><input type="text" class="j2222" value="${data.reserve3 }" disabled /> 
									</div>
									<div class="hx"></div>
									<span>申请理由：</span><input class="j2222" type="text" value="${data.inLineOptions2 }" disabled />
								</div>
								<div class="input-group1-2">
								    <div class="iput">
										<p class="p1">需求岗位任职资格</p>
										<span class="t1">姓别：</span><input type="text" value="${data.reserve11 }" disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">年龄：</span><input type="text" value="${data.reserve7 }"  disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">婚姻状况：</span><input type="text" value="${data.reserve12 }"  disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
								    <div class="iput">
										<span class="t1">经验：</span><input type="text" name="company" value="${data.reserve14 }" disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">专业：</span><input type="text" name="userName" value="${data.reserve8 }"  disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">学历：</span><input type="text" name="department" value="${data.reserve13 }"  disabled class="i-2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
									<div class="jj13" style="margin-left:-75px;">
									<span>任职要求：</span>
									<textarea class="ccsq-sqsy" style="width: 860px; background-color: #fefff8; margin-top: 8px;" placeholder="" disabled>${data.reserve9 }</textarea>
									<div class="hx"></div>
									<span>工作职责：</span>
									<textarea class="ccsq-sqsy" style="width: 860px; background-color: #fefff8; margin-top: 8px;" placeholder="" disabled>${data.reserve10 }</textarea>
									<div class="hx"></div>
									</div>
								 </div>
								...
								<div class="jj13">
									<span>流程：</span><img alt="" src="${path }/activiti/hisImage1?processInstanceId=${processInstanceId }" width="300" height="180" style="background-color: #EAEDF2;">
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/recruit_zpsq.js"></script>
