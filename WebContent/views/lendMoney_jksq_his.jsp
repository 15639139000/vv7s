...
<%
	...
	pageContext.setAttribute("name", "借款管理");
%>
<!DOCTYPE html>
<html>
<head>
							...
							<form method="post" id="form" enctype="multipart/form-data">
								<div class="nryc">
									...
									<div class="ccsq-xx" style="margin-left:75px; margin-top: 30px;">
										<span>借款事由：</span>
										<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve7" id="reserve7">${data.reserve7 }</textarea>
									</div>
...
<script type="text/javascript" src="${path }/js/lendMoney_jksq_his.js"></script>
