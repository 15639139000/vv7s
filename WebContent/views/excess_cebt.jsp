						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>出差区域：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>
									    <span>月回款额：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve7 }" disabled />
									    <div class="hx"></div>
									    <span>增加补贴标准：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve9 }" disabled />
									    <div class="hx"></div>
									    <span>应补贴金额：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve11 }" disabled />
									</div>
									<div class="jj13-rg">
										<span>月任务额：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>完成比例：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve8 }" disabled />
									    <div class="hx"></div>
									    <span>出差天数：</span><input type="text" name="reserve4" id="reserve4" class="j2222" value="${data.reserve10 }" disabled />
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/excess_cebt.js"></script>
