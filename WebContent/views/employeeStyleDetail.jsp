		...
		<div class="row bg">
			...
			<div class="col-lg-11">
				...
				<div class="notice_box">
					<h2 class="text-center">${employeeStyle.esTitle}</h2><br><br>
					<div class="notice_contion">
						<p style="font-size:16px;line-height:30px">
					${employeeStyle.esContent}
						</p>
					</div>
				</div>
				<br><br><br><br><br><br>
				<div class="notice_time">
					<p style="font-size:16px;">${employeeStyle.dept.dName}</p>
					<p style="font-size:16px;">${employeeStyle.employee.eName}</p>
					<p style="font-size:16px;"><fmt:formatDate value="${employeeStyle.esDate}" pattern="yyyy-MM-dd"/></p>
				</div>
			</div>
		</div>
	</div>
