...
<link type="text/css" rel="stylesheet" href="${path }/bootstrap/css/billboard.css" />
	...
	alert(f);
        ...
        for(var i=0;i<f.length;i++){  
            ...
            reader.onload = function(e){  
                str+="<img width='128px' height='128px' src='"+e.target.result+"'/>";  
							...
							<div class="tab-pane fade in active" id="home">
								<div class="col-md-12">
									...
									<div class="tile" id="edit">
										<div style="font-family: '微软雅黑'; margin-top: 50px; margin-bottom: 30px; margin-left: 270px; font-size: 17px; font-weight: bold;">龙虎榜信息录入</div>
										<div class="lhb" style="padding-left: 150px; padding-bottom: 20px; font-size: 14px; width: 100%;">
										<form class = "form-horizontal" action="" method="post" id="bForm" enctype="multipart/form-data" >
											<input type="hidden" id="bId" value=""/>	
												<span>姓名：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="" id="bName" name="name" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px; margin-top: 25px; margin-bottom: 25px;" /><span class="error1"></span><br>
												<span>所属团队：</span><input type="text" value="" id="team" name="team" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px; margin-top: 25px; margin-bottom: 25px;" /><span class="error2"></span><br>
												<span>日期：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="bDate" id="bDate" class="Wdate" 
								  			 			style="padding-left: 5px; width: 250px; height: 30px;margin-top: 25px; margin-bottom: 40px; border: none; background-color: #f5f5f5;"
								   						onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', readOnly: true });" format="yyyy-MM-dd"><span class="error3"></span><br>
												<span>名次：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="rank" id="rank1" value="1" checked="checked">
													冠军&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="radio" name="rank" id="rank2" value="2">
													亚军&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<input type="radio" name="rank" id="rank3" value="3">
													季军
												<br><br><br>
												<div id="imgPreview" style='width:128px; height:128px;display:none;'>
												</div>
												<!-- <div id = "Img"></div> -->
												<div >
													<div class="fileinput-button">
														<span>上传照片:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
														<!-- <input type=button id=filebutton value="选择图片 " style="width: 100px;height: 40px" onclick="photo.click()"> -->
														<%-- <img src="${path}/images/timg.jpg" style="width: 100px;height: 50px" onclick="photo.click()" > --%>
															<!-- <input type="file" id="photo" name="photo" accept="image/*" style="visibility:hidden" onchange="upload(this.value)"> -->
														<input type="file" id="photo" accept="image/*" name="photo"  onchange='PreviewImage(this)' />
													</div>
												</div>
												<br><br><br>
