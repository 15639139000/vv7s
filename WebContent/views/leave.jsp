...
<%
	...
	pageContext.setAttribute("page", "leave_qjsq.jsp");
	pageContext.setAttribute("name", "请假申请");
%>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="${path }/dist/zoomify.min.css"></script>
				...
				<div class="row ccsq-row">
					...
					<div class="col-lg-12  ccsq-bg">
						<ul id="myTab" class="nav nav-tabs ccsq-bt" style="width: 100%;">
							<li class="bt-jl"><a href="javascript:void(0);" data-toggle="tab" id="dw">待我处理工作</a></li>
...
<!-- 								<form method="post" id="form" enctype="multipart/form-data"> -->
								...
								<div class="ccsq-xx" id="nj" style="display:none;">
									<span>剩余年假：</span>
									<input type="text" name="reserve10" id="reserve10" value="5" class="ccsq-jbin" readonly="readonly"/>&nbsp;天 </br>
								</div>
								<div class="ccsq-xx">
...
<script type="text/javascript" src="${path }/js/leave.js"></script>
