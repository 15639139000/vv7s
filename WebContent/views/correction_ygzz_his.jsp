...
<%
	...
	pageContext.setAttribute("name", "员工转正申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>员工转正申请历史</title>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx">
										<span>试用岗位：</span><input type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" class="ccsq-jbin" /></br>
									</div>
									<div class="ccsq-xx">
										<span>试用期间：</span> 
										<input type="text" name="reserve6" id="reserve6" class="Wdate" value="${data.reserve6 }"
											   style="padding-left: 5px; width: 140px; height: 30px; border: none; background-color: #f5f5f5;"
											   onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', readOnly: true });"
											   format="yyyy-MM-dd">&nbsp;&nbsp; 
									...
									<div class="ccsq-xx">
										<span>试用薪资：</span><input type="text"  name="reserve8" id="reserve8" class="ccsq-jbin" value="${data.reserve8 }"/>&nbsp;元 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>期望薪资：</span><input type="text"  name="reserve9" id="reserve9" class="ccsq-jbin" value="${data.reserve9 }"/>&nbsp;元 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>自我工作评述：</span>
										<textarea class="ccsq-sqsy" placeholder=""  name="reserve10" id="reserve10">${data.reserve10 }</textarea>
									</div>
									<div class="ccsq-jtmx">
										<h3>自我评价</h3>
								...
								<div class="ccsq-xx">
									<span>自我评价结果：</span>
									<input type="radio" name="inLineOptions2" id="inlineRadio1" value="优秀90-100" checked="checked"> 优秀90-100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="inLineOptions2" id="inlineRadio2" value="良好80-89"> 良好80-89&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="inLineOptions2" id="inlineRadio3" value="一般65-79"> 一般65-79&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="inLineOptions2" id="inlineRadio3" value="差65以下"> 差65以下&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								...
								<c:if test="${data.message != '未提交' && data.message != '驳回' }">
								<div class="ccsq-jtmx">
											...
											<span id="tableData2" style="display:none;">${data.tableData2 }</span>
                                       </div>
									    <div class="jj13">
											<span>主管评价结果：</span><input class="j222" type="text" value="${data.inLineOptions3 == 'null' ? '' : data.inLineOptions3 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div> <div class="jj13">
											<span>转正情况：</span><input class="j222" type="text" value="${data.inLineOptions4 == 'null' ? '' : data.inLineOptions4 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div>
									  <div class="jj13">
											<span>岗&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：</span><input class="j222" type="text" value="${data.reserve11 == 'null' ? '' : data.reserve11 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div>
									   <div class="jj13">
											<span>工资标准：</span><input class="j222" type="text" value="${data.reserve12 == 'null' ? '' : data.reserve12 }&nbsp;元" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div>
									  <div class="jj13">
											<span>执行日期：</span><input class="j222" type="text" value="${data.reserve13 == 'null' ? '' : data.reserve13 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div>
									  <div class="jj13">
											<span>部门意见：</span><input class="j222" type="text" value="${data.reserve14 == 'null' ? '' : data.reserve14 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
											<div class="hx"></div>
									</div>
								</c:if>
...
<script type="text/javascript" src="${path }/js/correction_ygzz_his.js"></script>
