...
<%
	...
	pageContext.setAttribute("page", "gift.jsp");
	pageContext.setAttribute("name", "礼品申请");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
							    ...
							    <div class="ccsq-xx">
									   <span>客户名称：</span>
									   <input type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <span>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务：</span>
									   <input type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" class="ccsq-jbin"/><br>
									</div>
								    <div class="ccsq-xx">
									   <span>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</span>
									   <input type="number" name="reserve7" id="reserve7" value="${data.reserve7 }" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <span>费用预算：</span>
									   <input type="text" name="reserve8" id="reserve8" value="${data.reserve8 }" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <div style="margin-top: 20px;">
										<span>事由及目的：</span>
										<textarea name="reserve9" id="reserve9" style="width: 900px;height: 80px;background-color: #f5f5f5;padding: 5px;border: none;">${data.reserve9 }</textarea>
									   </div>
									</div>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabProduct1">
											<c:choose>
												<c:when test="${data.message == '驳回' }">
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">礼品名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">数量</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount2" EditType="TextBox">单价</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount3" EditType="TextBox">总计金额</td>
												</tr>
												</c:when>
												<c:otherwise>
												<tr class="ccsq-bdbt">
												<td width="32" align="center" bgcolor="#EFEFEF" Name="Num"><input type="hidden" name="checkbox" value="checkbox" /></td>
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount">礼品名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1">数量</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount2">单价</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount3">总计金额</td>
				                                    </tr>
												</c:otherwise>
											</c:choose>
										</table>
...
<script type="text/javascript" src="${path }/js/gift_lpsq_his.js"></script>
