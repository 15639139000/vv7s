...
<link type="text/css" rel="stylesheet" href="${path }/bootstrap/css/company_rules.css" />
							...
							<div class="tab-pane fade in active" id="home">
								<div class="col-md-12">
									...
									<div class="tile" id="edit">
										...
										<HR SIZE=3>
										<div style="font-family: '微软雅黑'; margin-top: 20px; margin-bottom: 20px; margin-left: 75px; font-size: 14px; font-weight: bold;">公司制度信息</div>
										<div style="padding-left: 75px; padding-bottom: 20px; font-size: 14px; width: 100%;">
											<input type="hidden" id="crId" value=""/>	
											公司制度标题：<input type="text" value="" id="crTitle" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px;" /><span class="error1"></span></br>
											<div style="margin-top: 20px;">
												公司制度内容：<textarea placeholder="请输入发布的公司制度内容......." id="crContent" style="width: 600px; height: 200px; background-color: #f5f5f5; border: none;"></textarea>
...
<script type="text/javascript" src="${path }/js/company_rules.js"></script>
