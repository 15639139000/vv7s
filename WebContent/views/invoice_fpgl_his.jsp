...
<%
	...
	pageContext.setAttribute("name", "发票管理");
%>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>客户税号：</span><input class="ccsq-jbpt-1" type="text" name="reserve2" id="reserve2" value="${data.reserve2 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>开户行：</span>&nbsp;&nbsp;
									   <input class="ccsq-jbpt-1" type="text" name="reserve3" id="reserve3" value="${data.reserve3 }"></div>
									   <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve4" id="reserve4" value="${data.reserve4 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>联系电话：</span><input class="ccsq-jbpt-1"  type="number" name="reserve5" id="reserve5" value="${data.reserve5 }"></div>
									   <span>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve7" id="reserve7" value="${data.reserve7 }"></div>
									   <span>产品编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="${data.reserve8 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品规格：</span><input class="ccsq-jbpt-1" type="text" name="reserve9" id="reserve9" value="${data.reserve9 }"></div>
									   <span>回款金额：</span>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品数量：</span><input class="ccsq-jbpt-1" type="number" name="reserve10" id="reserve10" value="${data.reserve10 }">
									   </div>
									   	<span>含税金额：</span>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>合同编号：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve15" id="reserve15" value="${data.reserve15 }"></div>
								       <span>是否回款：</span>
...
<script type="text/javascript" src="${path }/js/invoice_fpgl_his.js"></script>
