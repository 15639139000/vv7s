...
<%
	...
	pageContext.setAttribute("page", "gift_lpsq.jsp");
					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-jbxx">礼品申请信息</div>
								<div class="ccsq-xx">
									<span>紧急程度：</span> 
								...
								<div class="ccsq-xx">
									...
									<div class="ccsq-xx">
									   <span>客户名称：</span>
									   <input type="text" name="reserve5" id="reserve5" value="" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <span>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务：</span>
									   <input type="text" name="reserve6" id="reserve6" value="" class="ccsq-jbin"/><br>
									</div>
								    <div class="ccsq-xx">
									   <span>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</span>
									   <input type="number" name="reserve7" id="reserve7" value="" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <span>费用预算：</span>
									   <input type="text" name="reserve8" id="reserve8" value="" class="ccsq-jbin"/><br>
									</div>
									<div class="ccsq-xx">
									   <div style="margin-top: 20px;">
										<span>事由及目的：</span>
										<textarea name="reserve9" id="reserve9" style="width: 900px;height: 80px;background-color: #f5f5f5;padding: 5px;border: none;"></textarea>
									   </div>
									</div>
...
<script type="text/javascript" src="${path }/js/gift.js"></script>
