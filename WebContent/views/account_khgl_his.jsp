							...
							<form method="post" id="form" enctype="multipart/form-data">
								<div class="nryc">
									...
									<div class="jj13">
										...
										<input type="hidden" class="j222" id="inLineOptions3" value="${data.inLineOptions3 }"/>
									...
									<div class="ccsq-xx">
									 ...
									 <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   ...
										   <span>用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：</span>
										   <input class="ccsq-jbpt-1"  type="text" name="reserve5" id="reserve5" value="${data.reserve5 }"></div>
										   <span>账户名称：</span>
									    ...
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>开户银行：</span>
										   <input class="ccsq-jbpt-1"  type="text" name="reserve7" id="reserve7" value="${data.reserve7 }"></div>
										   <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
										   <input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="${data.reserve8 }">
									    </div>
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>开户性质：</span><input class="ccsq-jbpt-1"  type="text" name="reserve9" id="reserve9" value="${data.reserve9 }"></div>
											<span>有无网银：</span>
									    ...
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   ...
										   <span>U盾保管人：</span><input class="ccsq-jbpt-1"  type="text" name="reserve10" id="reserve10" value="${data.reserve10 }"></div>
											<span>是否结算卡：</span>
									    ...
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>结算卡保管人：</span><input class="ccsq-jbpt-1" type="text" name="reserve11" id="reserve11" value="${data.reserve11 }"></div>
									    </div>
...
<script type="text/javascript" src="${path }/js/account_khgl_his.js"></script>
