...
<%
	...
	pageContext.setAttribute("page", "excess_cebt.jsp");
	pageContext.setAttribute("name", "超额补贴申请");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-jbxx">超额补贴信息</div>
								<div class="ccsq-xx">
									<span>紧急程度：</span> 
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>出差区域：</span><input class="ccsq-jbpt-1" type="text" name="reserve5" id="reserve5" value=""></div>
									   <span>月任务额：</span><input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>月回款额：</span><input class="ccsq-jbpt-1" type="text" name="reserve7" id="reserve7" value=""></div>
									   <span>完成比例：</span><input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>补贴标准：</span><input class="ccsq-jbpt-1" type="text" name="reserve9" id="reserve9" value=""></div>
									   <span>出差天数：</span><input class="ccsq-jbpt-1" type="text" name="reserve10" id="reserve10" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>补贴金额：</span><input class="ccsq-jbpt-1" type="text" name="reserve11" id="reserve11" value=""></div>
								    </div>
...
<script type="text/javascript" src="${path }/js/excess.js"></script>
