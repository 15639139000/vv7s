...
<%
	...
	pageContext.setAttribute("page", "changeOfPersonal_rsyd.jsp");
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="input-group ccsq-clxx">
									<span>姓名：</span><input class="ccsq-jbpt" type="text" name="reserve1" id="reserve1" value="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>性别：</span><input class="ccsq-jbpt" type="text" name="reserve2" id="reserve2" value="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>年龄：</span><input class="ccsq-jbpt" type="number" name="reserve3" id="reserve3" value="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>文化程度：</span><input class="ccsq-jbpt" type="text" name="reserve4" id="reserve4" value="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>专业：</span><input class="ccsq-jbpt" type="text" name="reserve5" id="reserve5" value="计算机科学与技术" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>职称：</span><input class="ccsq-jbpt" type="text" name="reserve6" id="reserve6" value="" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>申请日期：</span>
								...
								<div class="input-group1-1"  style="margin-bottom: 30px;">
								        <div class="iput">
											<p class="p1">岗位及待遇</p>
											<span>【原任】&nbsp;&nbsp;部门：</span>   
										    <input type="text" value="" name="reserve7" id="reserve7" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>职务：</span>   
										    <input type="text" value=""  name="reserve8" id="reserve8" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>薪资：</span>   
										    <input type="text" value=""  name="reserve9" id="reserve9" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>到任日：</span>   
										    <input type="text" value=""  name="reserve10" id="reserve10" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
									    </div>
									    <div class="iput">
											<span>【新任】&nbsp;&nbsp;部门：</span>   
										    <input type="text" value=""  name="reserve11" id="reserve11" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>职务：</span>   
										    <input type="text" value=""  name="reserve12" id="reserve12" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>薪资：</span>   
										    <input type="text" value=""  name="reserve13" id="reserve13" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>到任日：</span>   
										    <input type="text" value=""  name="reserve14" id="reserve14" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
									    </div>
									</div> 
								
								<div class="ccsq-xx">
										<span>异动理由：</span>
										<textarea class="ccsq-sqsy" placeholder="" name="reserve15"  id="reserve15"></textarea>
								    </div>
...
<script type="text/javascript" src="${path }/js/changeOfPersonal.js"></script>
