						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="jj13-lf">
										<span>客户名称：</span>
									    <input type="text" class="j2222" value="${data.reserve1 }" disabled /> 
									    <div class="hx"></div>
									    <span>客户账号：</span>
									    <input type="text" class="j2222" value="${data.reserve3 }" disabled /> 
									    <div class="hx"></div>
									    <span>产品名称：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>
									    <span>结算数量：</span>
									    <input type="text" class="j2222" value="${data.reserve7 }" disabled /> 
									    <div class="hx"></div>
									    <span>结算金额：</span><input type="text" class="j2222" value="${data.reserve9 } , ${data.reserve10 }" disabled /> 
									    <div class="hx"></div>
									    <span>信息费金额：</span><input type="text" class="j2222" value="${data.reserve13 } , ${data.reserve14 }" disabled /> 
									    <div class="hx"></div>
									    <span>客户性质：</span><input type="text" class="j2222" value="${data.inLineOptions2 }" disabled /> 
									</div>
									<div class="jj13-rg">
										<span>客户编号：</span>
									    ...
									    <div class="hx"></div>
									    <span>开户行：</span>
									    <input type="text" class="j2222" value="${data.reserve4 }" disabled /> 
									    <div class="hx"></div>
									    <span>产品编号：</span>
									    <input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</span>
									    <input type="text" class="j2222" value="${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>回款金额：</span><input type="text" class="j2222" value="${data.reserve11 } , ${data.reserve12 }" disabled /> 
									    <div class="hx"></div>
									    <span>结算依据：</span><input type="text" class="j2222" value="${data.reserve15 }" disabled /> 
									    <div class="hx"></div>
									    <span>客户地址：</span><input type="text" class="j2222" value="${data.inLineOptions3 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
								
								<div class="card ccsq-bdd">
				                    <div class="card-action ccsq-bdd-bt">
				                                               使用人
				                    </div>
								...
								<div class="jj13">
									...
									<div class="jj13-lf">
										<span>合计金额：</span>
									    <input type="text" class="j2222" value="${data.inLineOptions4 } , ${data.tableData2 }" disabled /> 
									</div>
									<div class="jj13-rg">
										<span>支付方式：</span>
									    <input type="text" class="j2222" value="${data.tableData3 }" disabled />
								    </div>
								    <div class="hx"></div>
								</div> 
...
<script type="text/javascript" src="${path }/js/informationFee_xxfgl.js"></script>
