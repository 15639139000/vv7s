...
<%
	...
	pageContext.setAttribute("page", "chapter_yzsq.jsp");
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									...
									<span style="font-family: '微软雅黑'; font-size: 14px;">
										...
										用章时长：<span style="color: red;" id="date">0天0时</span>&nbsp;&nbsp;&nbsp;&nbsp;
									</span>
								</div>
								<div class="ccsq-xx">
									<span>紧急程度：</span> 
...
<script type="text/javascript" src="${path }/js/chapter.js"></script>
