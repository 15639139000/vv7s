	...
	<div class="container-fluid">
		<div class="row bg">
			...
			<div class="col-lg-11">
				...
				<div align="center" style=" margin-top: 150px;margin-bottom: 20px;margin-left: 75px;" >
				<font style="font-size:25px;color: #A8A8A8;">该功能未开放,待上线......</font>
				<a href="JavaScript:history.go(-1)"><font style="font-size: 25px;color: #317EEB;">返回</font></a>
				</div>
			</div>
		</div>
	</div>
