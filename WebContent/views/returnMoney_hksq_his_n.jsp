							...
							<div class="nryc">
								<div  class="input-group1-1">
										...
										<span class="t1">姓名：</span><input type="text" name="company" value="刘文华" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">公司：</span><input type="text" name="userName" value="今迈集团"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">部门：</span><input type="text" name="department" value="研发部"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">职称：</span><input type="text" name="department" value="经理"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">申请日期：</span><input type="text" name="applicationDate" value="2018-03-28" disabled class="i-1" /></br>	
									    </div>
								    </div>
								...
								<div class="ccsq-jbxx">账单信息</div>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;" >
									   <div style="padding-right: 100px; float: left;"><span>合同金额：</span>
									...
									<div class="dqr">
							            <img src="${path }/assets/images/dqr.png" />待确认...
								    </div>
