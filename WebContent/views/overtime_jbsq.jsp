...
<%
	...
	pageContext.setAttribute("page", "overtime.jsp");
%>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>加班时间：</span><input type="text" class="j2222" value="${data.reserve5 } ${data.reserve6 }   至   ${data.reserve7 } ${data.reserve8 }       共计${data.reserve9 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
								<div class="jj13">
									<span>加班理由：</span>
								    <textarea class="ccsq-sqsy" style="width: 860px; background:#fff; margin-top: 8px;" placeholder="" disabled>${data.reserve10 }</textarea>
									<div class="hx"></div>
							    </div>
...
<script type="text/javascript" src="${path }/js/overtime_jbsq.js"></script>
