...
<%
	...
	pageContext.setAttribute("page", "special.jsp");
%>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<p class="p1">发货信息</p>
									<span>紧急程度：</span>
									<input class="j222" type="text" name="inLineOptions1" id="inLineOptions1" value="${data.inLineOptions1 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>报货人：</span>
									<input class="j222" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>产品配置：</span>
									<input class="j222" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>收货人：</span>
									<input class="j222" type="text" name="reserve7" id="reserve7" value="${data.reserve7 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>收货电话：</span>
									<input class="j222" type="text" name="reserve8" id="reserve8" value="${data.reserve8 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>收货地址：</span>
									<input class="j222" type="text" name="reserve9" id="reserve9" value="${data.reserve9 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>运输方式：</span>
									<input class="j222" type="text" name="reserve10" id="reserve10" value="${data.reserve10 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>价格：</span>
									<input class="j222" type="text" name="reserve11" id="reserve11" value="${data.reserve11 }" disabled />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
									<div class="hx"></div>
									<span>公司名称：</span>
									<input type="text" class="j222" name="reserve12" id="reserve12" value="${data.reserve12 }" disabled /> 
									<div class="hx"></div>
									<span>联系人：</span>
									<input type="text" class="j222" name="reserve13" id="reserve13" value="${data.reserve13 }" disabled /> 
									<div class="hx"></div>
									<span>联系电话：</span>
									<input type="text" class="j222" name="reserve14" id="reserve14" value="${data.reserve14 }" disabled /> 
									<div class="hx"></div>
									<span>申请原因：</span>
									<input type="text" class="j222" name="reserve15" id="reserve15" value="${data.reserve15 }" disabled /> 
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/special_tsfh.js"></script>
