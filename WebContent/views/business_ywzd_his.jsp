...
<%
	...
	pageContext.setAttribute("name", "业务招待申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>业务招待申请历史</title>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx">
									<span>客户名称：</span><input type="text" name="reserve5" id="reserve5" class="ccsq-jbin" value="${data.reserve5 }" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务：</span><input type="text" name="reserve6" id="reserve6" class="ccsq-jbin" value="${data.reserve6 }" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</span><input type="number" name="reserve7" id="reserve7" class="ccsq-jbin" value="${data.reserve7 }" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
								    <span>客户人数：</span><input type="number" name="reserve8" id="reserve8" class="ccsq-jbin" value="${data.reserve8 }" />&nbsp;人<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>宴请标准：</span><input type="number" name="reserve9" id="reserve9" onblur="setCondition(this)" class="ccsq-jbin" value="${data.reserve9 }" />&nbsp;元/人<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>招待地点：</span><input type="text" name="reserve10" id="reserve10" class="ccsq-jbin" value="${data.reserve10 }" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
...
<script type="text/javascript" src="${path }/js/business_ywzd_his.js"></script>
