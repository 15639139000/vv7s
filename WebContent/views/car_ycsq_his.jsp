...
<%
	...
	pageContext.setAttribute("page", "car.jsp");
	pageContext.setAttribute("name", "用车申请");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx"><span>用车时间：</span>
										...
										<span style="font-family: '微软雅黑'; font-size: 14px;">
											...
											用车时长：<span style="color: red;" id="date">${data.reserve9 == '' ? '0天0时' : data.reserve9 }</span>&nbsp;&nbsp;&nbsp;&nbsp;
										</span>
	                            </div>
								<div class="ccsq-xx">
									   <span>用车类别：</span>
									   <input type="radio" name="inLineOptions2" id="inlineRadio4" value="临时用车" checked="checked">临时用车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									   <input type="radio" name="inLineOptions2" id="inlineRadio5" value="区域用车"> 区域用车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								<div class="ccsq-xx">
									   <span>行程安排：</span><input type="text" id="reserve11" name="reserve11" placeholder="请输入出发地" value="${data.reserve11 }" class="ccsq-jbin" />&nbsp;至 &nbsp;
									   					    <input type="text" id="reserve12" name="reserve12" placeholder="请输入目的地" value="${data.reserve12 }" class="ccsq-jbin" /></br>
									</div>
									<div class="ccsq-xx">
									   <span>随车人数：</span><input type="text" id="reserve13" name="reserve13" value="${data.reserve13 }" class="ccsq-jbin" />&nbsp;人 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
								<div class="ccsq-xx">
									<span>申请事由：</span>
									<textarea class="ccsq-sqsy" name="reserve10" id="reserve10" placeholder="请输入请假原因......">${data.reserve10 }</textarea>
								</div>
...
<script type="text/javascript" src="${path }/js/car_ycsq_his.js"></script>
