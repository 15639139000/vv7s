...
<%
	...
	pageContext.setAttribute("page", "printing_yspsq.jsp");
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									...
									<div class="ccsq-xx">
										<span>备注：</span>
										<textarea class="ccsq-sqsy" placeholder="" name="reserve5" id="reserve5"></textarea>
								    </div> 
...
<script type="text/javascript" src="${path }/js/printing.js"></script>
