							...
							<div class="nryc">
								...
								<div class="jj13">
									...
									<div class="jj13-lf">
									    ...
									    <div class="hx"></div>
									    <span>收款人开户行：</span><input type="text" class="j2222" value="${data.reserve3 }" disabled /> 
									    <div class="hx"></div>
									    <span>收款人账号：</span><input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>	
									    <span>收到发票金额：</span><input type="text" class="j2222" value="${data.reserve9 } , ${data.reserve10 }" disabled /> 
									    <div class="hx"></div>
									    <span>收到发票性质：</span><input type="text" class="j2222" value="${data.reserve13 }" disabled />
									    <div class="hx"></div>
									    <span>是否提供发票：</span><input type="text" class="j2222" value="${data.inLineOptions2 }" disabled />
									</div>
									<div class="jj13-lf">
										<span>合同名称：</span>
									    <input type="text" class="j2222" value="${data.reserve2 }" disabled /> 
									    <div class="hx"></div>
									    <span>合同金额：</span><input type="text" class="j2222" value="${data.reserve4 } , ${data.reserve5 }" disabled /> 
									    <div class="hx"></div>	
									    <span>已付金额：</span><input type="text" class="j2222" value="${data.reserve7 } , ${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>未付金额：</span><input type="text" class="j2222" value="${data.reserve11 } , ${data.reserve12 }" disabled /> 
									    <div class="hx"></div>
									    <span>本次应付金额：</span><input type="text" class="j2222" value="${data.reserve14 } , ${data.reserve15 }" disabled /> 
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/payment_fkgl.js"></script>
