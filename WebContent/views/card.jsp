...
<%
	...
	pageContext.setAttribute("page", "card_mpyssq.jsp");
								...
								<div class="ccsq-xx">
									...
									<input class="ccsq-sp" type="hidden" name="nextPerson" id="nextPerson" value="">
								 	...
								 	<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>姓名：</span><input class="ccsq-jbpt-1" type="text" name="reserve5" id="reserve5" value=""></div>
									   <span>公司：</span><input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>部门：</span><input class="ccsq-jbpt-1" type="text" name="reserve7" id="reserve7" value=""></div>
									   <span>职务：</span><input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>手机：</span><input class="ccsq-jbpt-1" type="number" name="reserve9" id="reserve9" value=""></div>
									   <span>固话：</span><input class="ccsq-jbpt-1" type="number" name="reserve10" id="reserve10" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>传真：</span><input class="ccsq-jbpt-1" type="number" name="reserve11" id="reserve11" value=""></div>
									   <span>邮箱：</span><input class="ccsq-jbpt-1" type="email" name="reserve12" id="reserve12" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
...
<script type="text/javascript" src="${path }/js/card.js"></script>
