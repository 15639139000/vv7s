...
<%
	...
	pageContext.setAttribute("page", "account_khgl.jsp");
	pageContext.setAttribute("name", "开户管理");
%>
<!DOCTYPE html>
<html>
<head>
							...
							<div id="leave3">
								<form method="post" id="form" enctype="multipart/form-data">
									...
									<div class="input-group ccsq-clxx">
										<span>姓名：</span><input class="ccsq-jbpt" type="text" name="reserve1" value="${employee.eName }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span>公司：</span><input class="ccsq-jbpt" type="text" name="reserve2" value="${employee.dept.company.cName }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span>部门：</span><input class="ccsq-jbpt" type="text" name="reserve3" value="${employee.dept.dName }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span>职位：</span><input class="ccsq-jbpt" type="text" name="reserve4" value="${employee.eManager }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span>申请日期：</span>
									...
									<div class="ccsq-xx">
									 ...
									 <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   ...
										   <span>用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：</span>
										   <input class="ccsq-jbpt-1"  type="text" name="reserve5" id="reserve5" value=""></div>
										   <span>账户名称：</span>
									    ...
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>开户银行：</span>
										   <input class="ccsq-jbpt-1"  type="text" name="reserve7" id="reserve7" value=""></div>
										   <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
										   <input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="">
									    </div>
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>开户性质：</span><input class="ccsq-jbpt-1"  type="text" name="reserve9" id="reserve9" value=""></div>
											<span>有无网银：</span>
											<input type="radio" name="inLineOptions2" id="inlineRadio1" value="无" checked="checked"> 无&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="inLineOptions2" id="inlineRadio2" value="有"> 有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    </div>
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 90px; float: left;">
										   <span>U盾保管人：</span><input class="ccsq-jbpt-1"  type="text" name="reserve10" id="reserve10" value=""></div>
											<span>是否结算卡：</span>
											<input type="radio" name="inLineOptions3" id="inlineRadio1" value="无" checked="checked"> 无&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="inLineOptions3" id="inlineRadio2" value="有"> 有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    </div>
									    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										   <div style="padding-right: 100px; float: left;">
										   <span>结算卡保管人：</span><input class="ccsq-jbpt-1" type="text" name="reserve11" id="reserve11" value=""></div>
									    </div>
