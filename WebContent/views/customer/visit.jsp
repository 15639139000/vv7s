...
<script type="text/javascript" src="${path }/js/visit.js"></script>
...
{
	$.ajaxFileUpload({
		url:path + '/customer/excelImportVisit',
		secureuri:false,
		fileElementId:'file',
		dataType: 'text',
...
{
	window.location.href = path + "/customer/excelExportVisit?fileName=" + encodeURIComponent("回访信息表");
}
</script>
</html>