...
<script type="text/javascript" src="${path }/ueditor/umeditor.config.js"></script>
<script type="text/javascript" src="${path }/ueditor/umeditor.js"></script>
							...
							<div class="tab-pane fade in active" id="home">
								<div class="col-md-12">
									...
									<div class="tile" id="edit">
										...
										<HR SIZE=3>
										<div style="font-family: '微软雅黑'; margin-top: 20px; margin-bottom: 20px; margin-left: 75px; font-size: 14px; font-weight: bold;">新闻信息</div>
										<div style="padding-left: 75px; padding-bottom: 20px; font-size: 14px; width: 100%;">
											<input type="hidden" id="esId" value=""/>	
											新闻标题：<input type="text" value="" id="esTitle" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px;" /><span class="error1"></span></br>
											<div style="margin-top: 20px;">
												新闻内容：
												<textarea placeholder="请输入发布的新闻内容......." id="esContent" style="width: 600px; height: 200px; background-color: #f5f5f5; border: none;"></textarea>
												<script type="text/javascript">
												var um = UM.getEditor('esContent');
												var value = um.getContent();
												</script>
...
<script type="text/javascript" src="${path }/js/employee_style.js"></script>
