...
<%
	...
	pageContext.setAttribute("page", "business_ywzd.jsp");
					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									<span>客户名称：</span><input type="text" name="reserve5" id="reserve5" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务：</span><input type="text" name="reserve6" id="reserve6" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：</span><input type="number" name="reserve7" id="reserve7" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
								    <span>客户人数：</span><input type="number" name="reserve8" id="reserve8" class="ccsq-jbin" />&nbsp;人<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>宴请标准：</span><input type="number" name="reserve9" id="reserve9" onblur="setCondition(this)" class="ccsq-jbin" />&nbsp;元/人<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx">
									<span>招待地点：</span><input type="text" name="reserve10" id="reserve10" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
								</div>
								<div class="ccsq-xx" style="margin-left:75px; margin-top: 30px;">
									<span>业务事由：</span>
									<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve11" id="reserve11"></textarea>
								</div>
