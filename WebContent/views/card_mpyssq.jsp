					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<p class="p1">名片信息</p>
									<span>紧急程度：</span><input class="j2222" type="text" name="inLineOptions1" id="inlineRadio3" value="${data.inLineOptions1 }" disabled />
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>姓名：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>
									    <span>部门：</span><input type="text" class="j2222" value="${data.reserve7 }" disabled />
									    <div class="hx"></div>
									    <span>手机号：</span><input type="text" class="j2222" value="${data.reserve9 }" disabled />
									    <div class="hx"></div>
									    <span>传真：</span><input type="text" class="j2222" value="${data.reserve11 }" disabled />
									</div>
									<div class="jj13-rg">
										<span>公司：</span><input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>职务：</span><input type="text" class="j2222" value="${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>固话：</span><input type="text" class="j2222" value="${data.reserve10 }" disabled /> 
									    <div class="hx"></div>
									     <span>邮箱：</span><input type="text" class="j2222" value="${data.reserve12 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/card_mpyssq.js"></script>
