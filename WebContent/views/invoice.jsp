...
<%
	...
	pageContext.setAttribute("page", "invoice_fpgl.jsp");
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>客户税号：</span><input class="ccsq-jbpt-1" type="text" name="reserve2" id="reserve2" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>开户行：</span>&nbsp;&nbsp;
									   <input class="ccsq-jbpt-1" type="text" name="reserve3" id="reserve3" value=""></div>
									   <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve4" id="reserve4" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>联系电话：</span><input class="ccsq-jbpt-1"  type="number" name="reserve5" id="reserve5" value=""></div>
									   <span>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve7" id="reserve7" value=""></div>
									   <span>产品编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品规格：</span><input class="ccsq-jbpt-1" type="text" name="reserve9" id="reserve9" value=""></div>
									   <span>回款金额：</span>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品数量：</span><input class="ccsq-jbpt-1" type="number" name="reserve10" id="reserve10" value="">
									   </div>
									   	<span>含税金额：</span>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>合同编号：</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve15" id="reserve15" value=""></div>
								       <span>是否回款：</span>
...
<script type="text/javascript" src="${path }/js/invoice.js"></script>
