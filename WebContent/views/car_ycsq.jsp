					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<span>紧急程度：</span><input class="j2222" type="text" name="inLineOptions1" id="inLineOptions1" value="${data.inLineOptions1 }" disabled />
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>用车时间：</span>
									    <input type="text" class="j2222" value="${data.reserve5 } ${data.reserve6 }   至   ${data.reserve7 } ${data.reserve8 }       共计${data.reserve9 }" disabled /> 
									    <div class="hx"></div>
									    <span>行程安排：</span><input type="text" class="j2222" value="${data.reserve11 }---->${data.reserve12 }" disabled />
									    <div class="hx"></div>
									    <span>用车事由：</span><input type="text" class="j2222" value="${data.reserve10 }" disabled /> 
									</div>
									<div class="jj13-rg">
										<span>用车类型：</span>
									    <input type="text" class="j2222" value="${data.inLineOptions2 }" disabled /> 
									    <div class="hx"></div>
									    <span>随车人数：</span><input type="text" class="j2222" value="${data.reserve13 }" disabled /> 
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/car_ycsq.js"></script>
