					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<span>紧急程度：</span><input class="j2222" type="text" name="inlineRadioOptions3" id="inlineRadio3" value="" disabled />
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>关联申请单：</span>
									    <input type="text" class="j2222" name="reserve1" id="reserve1" value="${data.reserve1 }" disabled /> 
									    <div class="hx"></div>
									    <span>合同名称：</span>
									    <input type="text" class="j2222" name="reserve3" id="reserve3" value="${data.reserve3 }" disabled /> 
									    <div class="hx"></div>
									    <span>借款金额：</span><input type="text" class="j2222" value="${data.reserve5 } 元，${data.reserve6 }" disabled /> 
									    <div class="hx"></div>	
									    <span>实报金额：</span><input type="text" class="j2222" value="${data.reserve9 } 元，${data.reserve10 }" disabled />
									</div>
									<div class="jj13-rg">
										<span>项目名称：</span>
									    <input type="text" class="j2222" name="reserve2" id="reserve2" value="${data.reserve2 }" disabled /> 
									    <div class="hx"></div>
									    <span>客户名称：</span>
									    <input type="text" class="j2222" name="reserve4" id="reserve4" value="${data.reserve4 }" disabled /> 
									    <div class="hx"></div>	
									    <span>报销合计：</span><input type="text" class="j2222" value="${data.reserve7 } 元，${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>报销周期：</span><input type="text" class="j2222" value="${data.reserve11 } 至 ${data.reserve13 }" disabled />
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/reimbursement_bxsq.js"></script>
