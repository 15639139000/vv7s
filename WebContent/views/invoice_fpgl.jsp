...
<%
	...
	pageContext.setAttribute("page", "invoice.jsp");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="jj13">
									<span>紧急程度：</span><input class="j2222" type="text" name="inLineOptions1" value="${data.inLineOptions1 }" disabled />
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>客户名称：</span><input type="text" class="j2222" value="${data.reserve1 }" disabled /> 
									    <div class="hx"></div>
									    <span>开户行：</span><input type="text" class="j2222" value="${data.reserve3 }" disabled /> 
									    <div class="hx"></div>
									    <span>联系电话：</span><input type="text" class="j2222" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>	
									    <span>产品名称：</span><input type="text" class="j2222" value="${data.reserve7 }" disabled /> 
									    <div class="hx"></div>
									    <span>产品规格：</span><input type="text" class="j2222" value="${data.reserve9 }" disabled /> 
									    <div class="hx"></div>
									    <span>含税金额：</span><input type="text" class="j2222" value="${data.reserve11 } , ${data.reserve12 }" disabled /> 
									    <div class="hx"></div>
									    <span>合同编号：</span><input type="text" class="j2222" value="${data.reserve15 }" disabled /> 
									</div>
									<div class="jj13-rg">
										<span>客户税号：</span><input type="text" class="j2222" value="${data.reserve2 }" disabled /> 
									    <div class="hx"></div>
									    <span>账号：</span><input type="text" class="j2222" value="${data.reserve4 }" disabled /> 
									    <div class="hx"></div>	
									    <span>地址：</span><input type="text" class="j2222" value="${data.reserve6 }" disabled /> 
									    <div class="hx"></div>
									    <span>产品编号：</span><input type="text" class="j2222" value="${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>产品数量：</span><input type="text" class="j2222" value="${data.reserve10 }" disabled /> 
									    <div class="hx"></div>
									    <span>回款金额：</span><input type="text" class="j2222" value="${data.reserve13 } , ${data.reserve14 }" disabled /> 
									    <div class="hx"></div>
									    <span>是否回款：</span><input type="text" class="j2222" value="${data.inLineOptions2 }" disabled /> 
									</div>
									<div class="hx"></div>
...
<script type="text/javascript" src="${path }/js/invoice_fpgl.js"></script>
