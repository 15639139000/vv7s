												...
												<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
												  <div class="modal-dialog" role="document" style="width: 1000px;height: 700px;">
												    <div class="modal-content">
												      ...
												      <div class="modal-body">
												       <span>流程：</span><img alt="" src="${path }/activiti/hisImage2?processInstanceId=${historyModel.processInstanceId }"" width="900" height="450" style="background-color:#EAEDF2;">
												      </div>
												      <div class="modal-footer">
...
<script type="text/javascript" src="${path }/js/tecReview_his.js"></script>
