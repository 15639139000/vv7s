...
<%
	...
	pageContext.setAttribute("page", "quit_lzsq.jsp");
	pageContext.setAttribute("name", "离职申请");
%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									   <span>入职时间：</span><input type="text" name="reserve5" id="reserve5" value="" class="ccsq-jbin" />
									</div>
									<div class="ccsq-xx">
									   <span>预计离职时间：</span><input type="text" name="reserve6" id="reserve6" value="" class="ccsq-jbin" />
									</div>
                                    <div class="ccsq-xx">
									   <span>离职类型：</span>
									...
									<div class="ccsq-xx">
										<span>离职原因：</span>
										<textarea class="ccsq-sqsy" name="reserve7" id="reserve7" placeholder="" ></textarea>
								    </div>
								    <div class="ccsq-xx">
										<span>详细说明：</span>
										<textarea class="ccsq-sqsy" name="reserve8" id="reserve8" placeholder="" ></textarea>
								    </div>
										...
										<h3>办公用品交接</h3>
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabProduct2">
												<tr class="ccsq-bdbt">
													<td width="32" align="center" bgcolor="#EFEFEF" Name="Num"><input type="hidden" name="checkbox" value="checkbox" /></td>
													<td width="120" bgcolor="#EFEFEF" Name="Num" EditType="TextBox">序号</td>
													<td width="103" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">办公用品</td>
													<td width="103" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">交接形式</td>
													<td width="103" bgcolor="#EFEFEF" Name="Amount2" EditType="TextBox">备注</td>
												</tr>
											</table>
...
<script type="text/javascript" src="${path }/js/quit.js"></script>
