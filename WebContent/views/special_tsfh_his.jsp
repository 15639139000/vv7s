...
<%
	...
	pageContext.setAttribute("name", "特殊发货申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>特殊发货申请历史</title>
							...
							<div class="nryc">
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>报&nbsp;&nbsp;货&nbsp;人：</span>
										<input type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" class="ccsq-jbpt-1" />
									</div>
									<span>产品配置：</span>
									<input type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>收&nbsp;&nbsp;货&nbsp;人：</span>
										<input type="text" name="reserve7" id="reserve7" value="${data.reserve7 }" class="ccsq-jbpt-1" />
									</div>
									<span>收货电话：</span>
									<input type="number" name="reserve8" id="reserve8" value="${data.reserve8 }" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>收货地址：</span>
										<input type="text" name="reserve9" id="reserve9" value="${data.reserve9 }" class="ccsq-jbpt-1" />
									</div>
									<span>运货方式：</span>
									<input type="text" name="reserve10" id="reserve10" value="${data.reserve10 }" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span>
										<input type="number" name="reserve11" id="reserve11" value="${data.reserve11 }" class="ccsq-jbpt-1" />
									</div>
									<span>公司名称：</span>
									<input type="text" name="reserve12" id="reserve12" value="${data.reserve12 }" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>联&nbsp;&nbsp;系&nbsp;人：</span>
										<input type="text" name="reserve13" id="reserve13" value="${data.reserve14 }" class="ccsq-jbpt-1" />
									</div>
									<span>联系电话：</span>
									<input type="number" name="reserve14" id="reserve14" value="${data.reserve14 }" class="ccsq-jbpt-1" />
								</div>
								<div class="ccsq-xx" style="position: relative;">
									<span>申请原因：</span> 
									<input type="hidden" name="reserve15" id="reserve15" value="${data.reserve15 }">
									<select id="select" style="width: 380px; height: 30px; border: none; background: #f5f5f5;">
										<option value="信息未备档">信息未备档</option>
										<option value="预付款未到50%，且无有效合同">预付款未到50%，且无有效合同</option>
										<option value="其他原因：注明">其他原因：注明</option>
									</select> 
									<input id="qtyy" style="width:541px;height:30px; border:none; background: #f5f5f5;padding-left:5px;position: absolute;top:0px;right:36%;" type="text" value="${data.reserve15 }">
								</div>
...
<script type="text/javascript" src="${path }/js/special_tsfh_his.js"></script>
