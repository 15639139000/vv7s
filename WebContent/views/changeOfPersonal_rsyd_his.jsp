...
<%
	...
	pageContext.setAttribute("page", "changeOfPersonal.jsp");
	pageContext.setAttribute("name", "人事异动申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>人事异动申请历史</title>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="input-group ccsq-clxx">
									<span>姓名：</span><input class="ccsq-jbpt" type="text" name="reserve1" id="reserve1" value="${data.reserve1 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>性别：</span><input class="ccsq-jbpt" type="text" name="reserve2" id="reserve2" value="${data.reserve2 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>年龄：</span><input class="ccsq-jbpt" type="number" name="reserve3" id="reserve3" value="${data.reserve3 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>文化程度：</span><input class="ccsq-jbpt" type="text" name="reserve4" id="reserve4" value="${data.reserve4 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>专业：</span><input class="ccsq-jbpt" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>职称：</span><input class="ccsq-jbpt" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>申请日期：</span>
									<input type="text" name="apply" id="apply" class="Wdate" value="${data.apply }"
								...
								<div class="ccsq-xx">
									<span>异动类型：</span>
									<input type="radio" name="inLineOptions2" id="inlineRadio1" value="晋升" checked="checked"> 晋升&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="inLineOptions2" id="inlineRadio2" value="调动"> 调动&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="inLineOptions2" id="inlineRadio3" value="降职"> 降职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="inLineOptions2" id="inlineRadio3" value="调薪"> 调薪&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="inLineOptions2" id="inlineRadio3" value="其他"> 其他&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
									<div class="input-group1-1"  style="margin-bottom: 30px;">
								        <div class="iput">
											<p class="p1">岗位及待遇</p>
											<span>【原任】&nbsp;&nbsp;部门：</span>   
										    <input type="text" name="reserve7" id="reserve7" value="${data.reserve7 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>职务：</span>   
										    <input type="text"  name="reserve8" id="reserve8" value="${data.reserve8 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>薪资：</span>   
										    <input type="text"  name="reserve9" id="reserve9" value="${data.reserve9 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>到任日：</span>   
										    <input type="text"  name="reserve10" id="reserve10" value="${data.reserve10 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
									    </div>
									    <div class="iput">
											<span>【新任】&nbsp;&nbsp;部门：</span>   
										    <input type="text"  name="reserve11" id="reserve11" value="${data.reserve11 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>职务：</span>   
										    <input type="text"  name="reserve12" id="reserve12" value="${data.reserve12 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>薪资：</span>   
										    <input type="text"  name="reserve13" id="reserve13" value="${data.reserve13 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
										    <span class="shu">|</span>
										    <span>到任日：</span>   
										    <input type="text"  name="reserve14" id="reserve14" value="${data.reserve14 }" class="ccsq-jbin" style="width:180px;height:30px; border:none; background: #F5F5F5; padding-left: 5px;">
									    </div>
									</div> 
									<div class="ccsq-xx">
										<span>异动理由：</span>
										<textarea class="ccsq-sqsy" name="reserve15"  id="reserve15">${data.reserve15 }</textarea>
								    </div>
...
<script type="text/javascript" src="${path }/js/changeOfPersonal_rsyd_his.js"></script>
