							...
							<div class="nryc">
								<div class="input-group1-1">
									...
									<div  class="input-group1-1">
								        <div class="iput">
										<p class="p1">客户方信息</p>
										<span class="t1">客户名称：</span><input type="text" value="${data.reserve5 }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">担任职务：</span><input type="text" value="${data.reserve6 }"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										            <span class="shu">|</span>
										<span class="t1">联系电话：</span><input type="text" value="${data.reserve7 }"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    </div>
								    </div>
								<div class="jj13">
									...
									<div class="hx"></div>
									<div class="jj13-lf">
										<span>费用预算：</span><input type="text" class="j2222" value="${data.reserve8 }" disabled /> 
									</div>
									<div class="hx"></div>
								</div>
								<div class="jj13">
									<span>事由及目的：</span>
								    <textarea class="ccsq-sqsy" style="width: 860px; background:#fff; margin-top: 8px;" disabled>${data.reserve9 }</textarea>
									<div class="hx"></div>
							    </div>
...
<script type="text/javascript" src="${path }/js/gift_lpsq.js"></script>
