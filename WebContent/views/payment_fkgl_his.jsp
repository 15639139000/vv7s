...
<%
	...
	pageContext.setAttribute("page", "payment.jsp");
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>收款人姓名：&nbsp;&nbsp;&nbsp;&nbsp;</span>
									   <input class="ccsq-jbpt-1"  type="text" name="reserve1" id="reserve1" value="${data.reserve1 }"></div>
									   <span>合同名称：&nbsp;&nbsp;</span>
									   <input class="ccsq-jbpt-1" type="text" name="reserve2" id="reserve2" value="${data.reserve2 }">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
										   <span>收款人开户行：</span>
										   <input class="ccsq-jbpt-1" type="text" name="reserve3" id="reserve3" value="${data.reserve3 }">
									   </div>
									   <span>合同金额：</span>
									   <input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve4" id="reserve4" value="${data.reserve4 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }">
									   <span style="padding:3px 6px;color:red;" id="error1"></span>
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>收款人账号：&nbsp;&nbsp;&nbsp;&nbsp;</span>
									   <input class="ccsq-jbpt-1"  type="text" name="reserve6" id="reserve6" value="${data.reserve6 }">
									   </div>
									   <span>已付金额：</span>
									   <input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve7" id="reserve7" value="${data.reserve7 }">元
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
										<div style="padding-right: 100px; float: left;">
											<span>是否提供发票：</span>
											<select style="width: 380px; height: 30px; border: none; background: #f5f5f5;" name="inLineOptions2" id="inLineOptions12">
												<option value="是">是</option>
												<option value="否">否</option>
											</select> 
											<input type="hidden" value="${data.inLineOptions2 }" id="inLineOptions2" />
										</div>
										<span>未付金额：</span>
								    ...
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;"><span>是否收到发票：</span>
									   	<select style="width:380px;height:30px; border:none; background: #f5f5f5;" name="reserve13" id="reserve113">
											<option value="是">是</option>
											<option value="否">否</option>	
									    </select>
									    <input type="hidden" value="${data.reserve13 }" id="reserve13" />
									   </div>
									   <span>本次应付金额：</span>
									   <input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve14" id="reserve14" value="${data.reserve14 }">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve15" id="reserve15" value="${data.reserve15 }">
...
<script type="text/javascript" src="${path }/js/payment_fkgl_his.js"></script>
