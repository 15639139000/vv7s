...
<%
	...
	pageContext.setAttribute("page", "informationFee_xxfgl.jsp");
							...
							<div id="leave3">
								...
								<div class="ccsq-jbxx">信息费信息</div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>客户名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve1" id="reserve1" value=""></div>
									   <span>客户编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve2" id="reserve2" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>客户账号：</span><input class="ccsq-jbpt-1" type="text" name="reserve3" id="reserve3" value=""></div>
									   <span>开户行：&nbsp;&nbsp;&nbsp;&nbsp;</span><input class="ccsq-jbpt-1" type="text" name="reserve4" id="reserve4" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>产品名称：</span><input class="ccsq-jbpt-1" type="text" name="reserve5" id="reserve5" value=""></div>
									   <span>产品编号：</span><input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>结算数量：</span><input class="ccsq-jbpt-1"  type="number" name="reserve7" id="reserve7" value=""></div>
										<span>单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</span>
										<input class="ccsq-jbpt-1"  type="number" name="reserve8" id="reserve8" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   	<span>结算金额：</span>
									   ...
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve10" id="reserve10" value="请输入大写金额">
										...
										<span>信息费结算依据：</span>
										<input class="ccsq-jbpt-1"  type="text" name="reserve15" id="reserve15" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 85px; float: left;">
									   	<span>信息费金额：</span>
									   	<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="reserve13" id="reserve13" value="0">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="reserve14" id="reserve14" value="请输入大写金额">
									  	<span style="padding:3px 6px;color:red;position:absolute;" id="error3"></span>
									   </div>
										<span>客户性质：</span><input class="ccsq-jbpt-1" type="text" name="inLineOptions2" id="inLineOptions2" value="">
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>回款金额：</span>
									   ...
									   <span style="padding:3px 6px;color:red;position:absolute;" id="error2"></span>
										...
										<span>客户地址：</span>
										<input class="ccsq-jbpt-1"  type="text" name="inLineOptions3" id="inLineOptions3" value="">
								    </div>
									...
									<div class="ccsq-jtmx">
									  ...
									  <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   	<span>合计金额：</span>
									   	<input class="ccsq-jbpt-1" style="width: 140px;" type="number" name="inLineOptions4" id="inLineOptions4" value="0">元
									   <input class="ccsq-jbpt-1" style="width: 212px; margin-left: 10px;" type="text" name="tableData2" id="tableData2" value="请输入大写金额">
									   <span style="padding:3px 6px;color:red;position:absolute;" id="error4"></span>
									   </div>
										<span>支付方式：</span>
										<input class="ccsq-jbpt-1"  type="text" name="tableData3" id="tableData3" value="">
								    </div>
								    <div class="ccsq-xx">
										<span>详情备注：</span>
										<textarea class="ccsq-sqsy" placeholder=""  name="tableData4" id="tableData4"></textarea>
								    </div>
...
<script type="text/javascript" src="${path }/js/informationFee.js"></script>
