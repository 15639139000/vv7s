		...
		<div class="row bg">
			...
			<div class="col-lg-11">
				...
				<div class="notice_box">
					<h2 class="text-center">${noticeBulletin.nbTitle}</h2><br><br>
					<div class="notice_contion">
						<p style="font-size:16px;line-height:30px">
					${noticeBulletin.nbContent}
						</p>
					</div>
				<br><br><br><br><br><br>
					<div class="notice_time">
						<p style="font-size:16px;">${noticeBulletin.dept.dName}</p>
						<p style="font-size:16px;">${noticeBulletin.employee.eName}</p>
						<p style="font-size:16px;"><fmt:formatDate value="${noticeBulletin.nbDate}" pattern="yyyy-MM-dd"/></p>
					</div>
				</div>
			</div>
		</div>
