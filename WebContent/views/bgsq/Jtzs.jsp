				   ...
				   <div class="row">
			  		<div class="col-lg-8 header">
						...
						<div class="group" style="margin-left: -14px;">
							  <shiro:hasPermission name="permission:intojtzs"><button class="jt-group" id="intoJtzs" style="background: #019ee1;">集团直属视窗</button></shiro:hasPermission>
							...
							<div class="group">
							   <shiro:hasPermission name="permission:intohq"><button class="jt-group" id="intoHq">衡器视窗</button></shiro:hasPermission>
			  	   ...
			  	   <div class="row ccsq-row">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
						  <div class="tab-pane fade in active" id="home">
						  	<div class="sou1">
										<input type="text" class="sso" name="startTime" id="startTime" value="" placeholder="请选择开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
										<input type="text" class="sso" name="startTime1" id="startTime1" value="" placeholder="请选择结束时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
...
<script type="text/javascript" src="${path }/js/bg-Jtzs.js"></script>
