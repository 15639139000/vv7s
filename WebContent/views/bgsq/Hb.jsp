			...
			<div class="row bg">
				...
				<!-- 四个按钮 -->
						...
						<div class="group" style="margin-left: -14px;">
							...
							<div class="group">
							   <shiro:hasPermission name="permission:intohb"><button class="jt-group" id="intoHb" style="background: #019ee1;">环保视窗</button></shiro:hasPermission>
...
<script type="text/javascript" src="${path }/js/bg-Hb.js"></script>
