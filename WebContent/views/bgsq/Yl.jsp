				   ...
				   <div class="row">
			  		<div class="col-lg-8 header">
						...
						<div class="group" style="margin-left: -14px;">
							...
							<div class="group">
							   <shiro:hasPermission name="permission:intoyl"><button class="jt-group" id="intoYl" style="background: #019ee1;">园林视窗</button></shiro:hasPermission>
...
<script type="text/javascript" src="${path }/js/bg-Yl.js"></script>
