...
<%
	...
	pageContext.setAttribute("page", "chapter.jsp");
	pageContext.setAttribute("name", "用章申请");
%>
<!DOCTYPE html>
<html>
<head>
							...
							<div class="nryc">
								...
								<div class="ccsq-xx">
									...
									<span style="font-family: '微软雅黑'; font-size: 14px;">
										...
										用章时长：<span style="color: red;" id="date">${data.reserve9 == '' ? '0天0时' : data.reserve9 }</span>&nbsp;&nbsp;&nbsp;&nbsp;
									</span>
								</div>
								<div class="ccsq-xx">
									<span>紧急程度：</span> 
								...
								<div class="ccsq-xx">
									   <span>用章类型：</span>
									   <input type="radio" name="inLineOptions2" id="inlineRadio4" value="使用" checked="checked">使用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									   <input type="radio" name="inLineOptions2" id="inlineRadio5" value="外借">外借&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabProduct1">
											<c:choose>
												<c:when test="${data.message == '驳回' }">
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount" EditType="TextBox">盖章文件名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1" EditType="TextBox">份数</td>
												</tr>
												</c:when>
												<c:otherwise>
												<tr class="ccsq-bdbt">
												<td width="32" align="center" bgcolor="#EFEFEF" Name="Num"><input type="hidden" name="checkbox" value="checkbox" /></td>
													...
													<td width="700" bgcolor="#EFEFEF" Name="Amount">盖章文件名称</td>
													<td width="700" bgcolor="#EFEFEF" Name="Amount1">份数</td>
				                                    </tr>
												</c:otherwise>
											</c:choose>
										</table>
...
<script type="text/javascript" src="${path }/js/chapter_yzsq_his.js"></script>
