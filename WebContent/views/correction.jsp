...
<%
	...
	pageContext.setAttribute("page", "correction_ygzz.jsp");
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<input class="ccsq-sp" type="hidden" name="follow" value="关注">
									...
									<div class="ccsq-jbxx">员工转正申请信息</div>
									<div class="ccsq-xx">
										<span>紧急程度：</span> 
									...
									<div class="ccsq-xx">
										<span>试用岗位：</span><input type="text" name="reserve5" id="reserve5" value="" class="ccsq-jbin" /></br>
									</div>
									<div class="ccsq-xx">
										<span>试用期间：</span> 
										<input type="text" name="reserve6" id="reserve6" class="Wdate" 
											   style="padding-left: 5px; width: 140px; height: 30px; border: none; background-color: #f5f5f5;"
											   onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', readOnly: true });"
											   format="yyyy-MM-dd">&nbsp;&nbsp; 
									...
									<div class="ccsq-xx">
										<span>试用薪资：</span><input type="number"  name="reserve8" id="reserve8" class="ccsq-jbin" />&nbsp;元 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>期望薪资：</span><input type="number"  name="reserve9" id="reserve9" class="ccsq-jbin" />&nbsp;元 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>自我工作评述：</span>
										<textarea class="ccsq-sqsy" placeholder=""  name="reserve10" id="reserve10"></textarea>
									</div>
									<div class="ccsq-jtmx">
										<h3>自我评价</h3>
