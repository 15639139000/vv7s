						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="ccsq-xx">
									   ...
									   <div class="ccsq-xx">
									   <span>岗&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：</span><input type="text" name="reserve11" id="reserve11" class="ccsq-jbin" value=""/>&nbsp; <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
									   <span>工资标准：</span><input type="number" name="reserve12" id="reserve12" class="ccsq-jbin" value=""/>&nbsp;元 <!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>执行日期：</span><input type="text" name="reserve13" id="reserve13" value="" class="Wdate" style="padding-left: 5px;width: 180px;height: 30px;border: none;background-color: #f5f5f5;" onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', readOnly: true });" format="yyyy-MM-dd">
				                    </div>
				                    <div class="ccsq-xx">
					                    <span>部门意见：</span>
										<textarea class="ccsq-sqsy" name="reserve14" id="reserve14" style="width: 860px; background-color: #f5f5f5; margin-top: 8px;" placeholder="" ></textarea>
										<div class="hx"></div>
									</div>
                                 </c:if>
								<c:if test="${employee.eName != nextPerson }">
