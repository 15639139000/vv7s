...
<%
	...
	pageContext.setAttribute("page", "assets_gdzc.jsp");
	pageContext.setAttribute("name", "固定资产借出申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>固定资产借出申请</title>
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								<form method="post" id="form" enctype="multipart/form-data">
									...
									<div class="ccsq-jbxx">固定资产借出信息</div>
									<div class="ccsq-xx">
										<span>紧急程度：</span> 
									...
									<div class="ccsq-xx">
										<span>物品名称：</span><input type="text" id="reserve5" name="reserve5" class="ccsq-jbin" />&nbsp;<!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span>借出原因：</span><textarea class="ccsq-sqsy" id="reserve6" name="reserve6"></textarea>&nbsp;<br><!--<button type="button" style="width: 70px;height: 30px;background-color: #019ee1;color: #FFFFFF;border: none;">浏览</button>-->
									</div>
									<div class="ccsq-xx">
										<span style="font-size: 14px; color: #f48000; font-weight: 100; margin-top: 20px;">备注：外借资产请个人妥善保管，如出现损坏，后果自负！</span>
									</div>
...
<script type="text/javascript" src="${path }/js/assets.js"></script>
