...
<%
	...
	pageContext.setAttribute("name", "投标保证金申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>投标保证金申请历史</title>
					...
					<div class="col-lg-12  ccsq-bg">
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
							    ...
							    <div class="ccsq-xx">
									<span>投标名称：</span>
									<input class="ccsq-jbin" style="width:505px;" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }">
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<span>投&nbsp;&nbsp;标&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;期：</span>
									<input type="text" name="reserve6" id="reserve6" value="${data.reserve6 }" class="Wdate" style="padding-left: 5px;width: 180px;height: 30px;border: none;background-color: #f5f5f5;" onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd', readOnly: true });" format="yyyy-MM-dd">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>投&nbsp;标&nbsp;金&nbsp;额：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="number" name="reserve7" id="reserve7" value="${data.reserve7 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<span>投标保证金金额：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="number" name="reserve8" id="reserve8" value="${data.reserve8 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<span>接收单位名称：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="text" name="reserve9" id="reserve9" value="${data.reserve9 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									<span>开户行名称：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="text" name="reserve10" id="reserve10" value="${data.reserve10 }"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									<span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="text" name="reserve11" id="reserve11" value="${data.reserve11 }" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<span>部&nbsp;门&nbsp;负&nbsp;责人：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="text" name="reserve12" id="reserve12" value="${data.reserve12 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									<span>财务负责人：</span>
									<input class="ccsq-jbpt-1" style="width: 180px;" type="text" name="reserve13" id="reserve13" value="${data.reserve13 }"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
								<div class="ccsq-xx" style="margin-left:75px; margin-top: 30px;">
									<span>备注：</span>
									<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve14" id="reserve14">${data.reserve14 }</textarea>
								</div>
...
<script type="text/javascript" src="${path }/js/margin_tbbzj_his.js"></script>
