...
<%
	...
	pageContext.setAttribute("page", "account.jsp");
%>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								<div class="input-group1-1">
									<div class="iput">
										<p class="p1">申请人信息</p>
										<span class="t1">姓名：</span><input type="text" name="reserve1" value="${data.applicant }" disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">公司：</span><input type="text" name="reserve2" value="${applyCompany }"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">部门：</span><input type="text" name="reserve3" value="${applyDept }"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
										<span class="t1">职称：</span><input type="text" name="reserve4" value="${applyManager }"  disabled class="i-1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<span class="shu">|</span>
								...
								<div class="jj13">
									...
									<div class="jj13-lf">
										<span>用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：</span>
										<input type="text" class="j2222" name="reserve5" value="${data.reserve5 }" disabled /> 
									    <div class="hx"></div>
									    <span>开户银行：</span><input class="j2222" type="text" name="reserve7" value="${data.reserve7 }" disabled />
									    <div class="hx"></div>
									    <span>开户性质：</span>
									    <input type="text" class="j2222" name="reserve9" value="${data.reserve9 }" disabled /> 
									    <div class="hx"></div>
									    <span>U盾保管人：</span><input class="j2222" type="text" name="reserve10" value="${data.reserve10 }" disabled />
									    <div class="hx"></div>
									    <span>结算卡保管人：</span><input class="j2222" type="text" name="reserve11" value="${data.reserve11 }" disabled />
									</div>
									<div class="jj13-rg">
										<span>账户名称：</span>
									    <input type="text" class="j2222" name="reserve6" value="${data.reserve6 }" disabled />
									    <div class="hx"></div>
									    <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
									    <input type="text" class="j2222" name="reserve8" value="${data.reserve8 }" disabled /> 
									    <div class="hx"></div>
									    <span>有无网银：</span><input class="j2222" type="text" name="inLineOptions2" value="${data.inLineOptions2 }" disabled />
									    <div class="hx"></div>
									    <span>是否结算卡：</span><input class="j2222" type="text" name="inLineOptions3" value="${data.inLineOptions3 }" disabled />
									    <div class="hx"></div>
									</div>
									<div class="hx"></div>
								</div>
...
<script type="text/javascript" src="${path }/js/account_khgl.js"></script>
