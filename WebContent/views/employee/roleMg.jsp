...
<script type="text/javascript">
	...
	function build_noticeBulletin_table(result)
	{
		...
		$.each(operations, function(index, item){
			var id = $("<td></td>").append(item.rId);
			var name = $("<td></td>").append(item.rName);
			var desc = $("<td></td>").append(item.rDesc);
			...
			var btnOperEdit = "<span color=siver>|</span><a href='javascript:void(0)' color='#317EEB'>&nbsp;&nbsp;<font color='#317EEB'>编辑权限</font>&nbsp;&nbsp;&nbsp;&nbsp;</a>";
			var btnJurEdit = "<span color=siver>|</span><a href='javascript:void(0)' color='#317EEB'>&nbsp;&nbsp;<font color='#317EEB'>编辑菜单</font>&nbsp;&nbsp;&nbsp;&nbsp;</a>";
			var btn = $("<td></td>").append(btnEdit).append(btndel).append(btnOperEdit).append(btnJurEdit);
		...
		<div class="row bg">
			<div class="col-lg-1 left-navigation">
				...
				<ul class="vertical-nav">
					...
					<%-- 实现角色不同的角色，则使用<shiro:hasPermission name="角色:角色"></shiro:hasPermission>判断 --%>
				</ul>
							...
							<div class="tab-pane fade in active" id="home">
								<div class="col-md-12">
									...
									<div class="tile" id="edit">
										...
										<HR SIZE=3>
										<div style="font-family: '微软雅黑'; margin-top: 20px; margin-bottom: 20px; margin-left: 75px; font-size: 14px; font-weight: bold;">添加角色</div>
										<div style="padding-left: 75px; padding-bottom: 20px; font-size: 14px; width: 100%;">
											<input type="hidden" id="rId" value=""/>	
											角色名称：<input type="text" value="" id="rName" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px;" /><span class="error1"></span></br></br></br>
											角色描述：<input type="text" value="" id="rDesc" style="background-color: #f5f5f5; border: none; width: 250px; height: 30px;" /><span class="error1"></span></br>
...
<script type="text/javascript" src="${path }/js/employee/roleMg.js"></script>
