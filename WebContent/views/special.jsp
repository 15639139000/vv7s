...
<%
	...
	pageContext.setAttribute("page", "special_tsfh.jsp");
					...
					<div class="col-lg-12  ccsq-bg">
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx">
									<span>紧急程度：</span> <input type="radio" name="inLineOptions1"
										id="inlineRadio1" value="一般" checked="checked">
									一般&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
										name="inLineOptions1" id="inlineRadio2" value="重要">
									重要&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
										name="inLineOptions1" id="inlineRadio3" value="紧急">
									紧急
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>报&nbsp;&nbsp;货&nbsp;人：</span>
										<input type="text" name="reserve5" id="reserve5" class="ccsq-jbpt-1" />
									</div>
									<span>产品配置：</span>
									<input type="text" name="reserve6" id="reserve6" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>收&nbsp;&nbsp;货&nbsp;人：</span>
										<input type="text" name="reserve7" id="reserve7" class="ccsq-jbpt-1" />
									</div>
									<span>收货电话：</span>
									<input type="number" name="reserve8" id="reserve8" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>收货地址：</span>
										<input type="text" name="reserve9" id="reserve9" class="ccsq-jbpt-1" />
									</div>
									<span>运货方式：</span>
									<input type="text" name="reserve10" id="reserve10" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：</span>
										<input type="number" name="reserve11" id="reserve11" class="ccsq-jbpt-1" />
									</div>
									<span>公司名称：</span>
									<input type="text" name="reserve12" id="reserve12" class="ccsq-jbpt-1" />
								</div>
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									<div style="padding-right: 100px; float: left;">
										<span>联&nbsp;&nbsp;系&nbsp;人：</span>
										<input type="text" name="reserve13" id="reserve13" class="ccsq-jbpt-1" />
									</div>
									<span>联系电话：</span>
									<input type="number" name="reserve14" id="reserve14" class="ccsq-jbpt-1" />
								</div>
								<div class="ccsq-xx" style="position: relative;">
									<span>申请原因：</span> 
									<input type="hidden" name="reserve15" id="reserve15" value="">
									...
									<input id="qtyy" style="width:541px;height:30px; border:none; background: #f5f5f5;padding-left:5px;position: absolute;top:0px;right:38%;" type="text" value="请输入原因">
								</div>
