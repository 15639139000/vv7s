...
<%
	...
	pageContext.setAttribute("page", "lendMoney_jksq.jsp");
						...
						<div id="myTabContent" class="tab-content" style="height: 810px;">
							...
							<div id="leave3">
								...
								<div class="ccsq-xx" style="margin-left:75px; margin-top: 30px;">
									<span>借款事由：</span>
									<textarea class="ccsq-sqsy" style="width: 860px;" name="reserve7" id="reserve7"></textarea>
								</div>
...
<script type="text/javascript" src="${path }/js/lendMoney.js"></script>
