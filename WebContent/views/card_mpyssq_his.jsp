...
<%
	...
	pageContext.setAttribute("page", "card.jsp");
	pageContext.setAttribute("name", "名片印刷申请");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>名片印刷申请历史</title>
						...
						<div class="col-lg-12  ccsq-bg">
							...
							<div class="nryc">
								...
								<div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   ...
									   <span>姓名：</span><input class="ccsq-jbpt-1" type="text" name="reserve5" id="reserve5" value="${data.reserve5 }"></div>
									   <span>公司：</span><input class="ccsq-jbpt-1" type="text" name="reserve6" id="reserve6" value="${data.reserve6 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>部门：</span><input class="ccsq-jbpt-1" type="text" name="reserve7" id="reserve7" value="${data.reserve7 }"></div>
									   <span>职务：</span><input class="ccsq-jbpt-1" type="text" name="reserve8" id="reserve8" value="${data.reserve8 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>手机：</span><input class="ccsq-jbpt-1" type="number" name="reserve9" id="reserve9" value="${data.reserve9 }"></div>
									   <span>固话：</span><input class="ccsq-jbpt-1" type="number" name="reserve10" id="reserve10" value="${data.reserve10 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
								    <div class="input-group ccsq-clxx" style="margin-bottom: 30px;">
									   <div style="padding-right: 100px; float: left;">
									   <span>传真：</span><input class="ccsq-jbpt-1" type="number" name="reserve11" id="reserve11" value="${data.reserve11 }"></div>
									   <span>邮箱：</span><input class="ccsq-jbpt-1" type="email" name="reserve12" id="reserve12" value="${data.reserve12 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    </div>
...
<script type="text/javascript" src="${path }/js/card_mpyssq_his.js"></script>
